...
class _AdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  loginAdminNow() async{
    var res = await http.post(Uri.parse(API.adminLogin),
      body:{
    ...
    if(res.statusCode==200)
    {
      ...
      if(resBodyOfLogin['status']== 'success')
      {
        ...
        print("data ======> " + resBodyOfLogin['adminData'].toString());
                  ...
                  child: Padding(
                    ...
                    child: Column( mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      children: [
                        ...
                        Text("Admin Dashboard",style: TextStyle(fontSize: 40,color: Colors.white,fontWeight: FontWeight.bold),),
